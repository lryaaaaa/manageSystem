<template>
  <div>
    ...
    >
          ...
          <el-form label-position="left" class="demo-table-expand">
            ...
            <el-form-item label="分类：">
              ...
              >&nbsp;<el-button
                ...
                @click="changeBookCate(props.row)"
                type="text"
                style="float: right"
                size="mini"
                icon="el-icon-edit"
            ...
            <el-form-item label="出版社：">
              ...
              >&nbsp;<el-button
                ...
                @click="changeBookPress(props.row)"
                type="text"
                style="float: right"
                size="mini"
                icon="el-icon-edit"
            ...
            <el-form-item label="价格：">
              ...
              >&nbsp;<el-button
                ...
                @click="changeBookPrice(props.row)"
                type="text"
                style="float: right"
                size="mini"
                icon="el-icon-edit"
      ...
      <el-table-column sortable label="交易次数" prop="deal">
      </el-table-column>
