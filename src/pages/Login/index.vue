...
<div class="login-wrap"  
 ...
 <div :class="{'right-panel-active':flag}" class="container">
    ...
    <div class="container_form container--signin">
        <form class="form">
            <h2 class="form_title">系统登录</h2>
    
            <input type="tel" placeholder="User" class="input" v-model="loginMsg.phone"/>
            <input type="password" placeholder="Password" class="input" v-model="loginMsg.pwd" @keydown.enter="sendLoginMsg"/>
        <div>
                <el-radio v-model="loginMsg.radio1" label="admin">管理员</el-radio>
            <el-radio v-model="loginMsg.radio1" label="super">超级管理员</el-radio>
        </div>
